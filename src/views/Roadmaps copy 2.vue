          ...
          >
            <div class="roadmaps-data" v-if="i.img_url !== ''">
              <figure
                ...
                style="padding: 2em 2em 3em 3em"
              >
                <img :src="i.img_url" alt="Description" />
              </figure>

              <ul v-for="z in i.dataInfo" :key="z.id" id="botoes">
                <li>
                  <figure class="image is-64x64">
                    <img
                      class="is-rounded"
          ...
          infoData: [
            {
              ...
              dataInfo: [
                {
                  checked: 1,
                  lists: "Conceptualisation of ProjectOasis",
                },
                {
                  checked: 0,
                  lists: "Formation of the ProjectOasis Team",
                },
                {
                  checked: 0,
                  lists: "Starting the Development of MVP",
                },
              ],
            },
          ],
