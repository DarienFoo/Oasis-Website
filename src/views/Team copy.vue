    ...
    <div class="column is-12 has-padding">
      ...
      <div class="slider-nav">
        <div
          ...
          :key="i.id"
        >
          <button class="button team-default is-extra-bold">
            {{ i.title }}
          </button>
        </div>
      </div>
      <div class="slider-for">
        ...
        <div id="slickLeonardo" class="team-info-char" style="width: 100% !important">
          <div
            class="team-left-container"
        ...
        <div id="slickDreamers" class="team-info-char" style="width: 100% !important">
          <div
            class="team-left-container"
